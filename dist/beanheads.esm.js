...
var Base = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var Eyes = _ref.eyes,
  ...
  return React.createElement("svg", Object.assign({
  ...
  }, rest), mask && React.createElement(Mask, {
    id: "mask"
  }), React.createElement("g", {
    mask: mask ? "url(#mask)" : undefined
  }, mask && React.createElement(BgCircle, {
    ...
    color: clothingColor,
    graphic: Graphic
  }), !faceMask && React.createElement(FacialHair, {
    color: hairColor
  }), React.createElement(Eyes, {
    withLashes: lashes
  }), React.createElement(Mouth, {
    lipColor: lipColor
  }), faceMask && React.createElement(FaceMask, {
    color: faceMaskColor
  }), React.createElement(FrontHair, {
    hairColor: hairColor,
    hasHat: FrontHat !== Noop
  }), React.createElement(Eyebrows, null), React.createElement(FrontHat, {
    color: hatColor,
    scale: hatScale
...
var Front$c = function Front(_ref) {
  ...
  return React.createElement("g", {
    ...
    d: "M512 190 Q555 330 608 440 Q550 420 502 424 Q516 310 500 195 Z",
    fill: shadow
  }), React.createElement("circle", {
    cx: 408,
    cy: 130,
    ...
    d: "M255 464 Q490 512 725 464 Q490 492 255 464 Z",
    fill: shadow
  }), React.createElement("path", {
    d: "M395 442 Q490 420 600 442 L596 420 Q490 398 400 420 Z",
    fill: shadow,
    stroke: colors.outline,
    strokeMiterlimit: 10,
    strokeWidth: "8px"
    ...
    d: "M432 300 L446 272 L460 300 L446 328 Z",
    fill: "white",
    stroke: colors.outline,
    strokeMiterlimit: 10,
    strokeWidth: "6px"
  }), React.createElement("path", {
    d: "M540 358 L552 334 L564 358 L552 382 Z",
    fill: "white",
    stroke: colors.outline,
    strokeMiterlimit: 10,
    strokeWidth: "6px"
...
function FullBeanHead(_ref2) {
  ...
  return React.createElement("svg", {
    ...
    width: "100%",
    xmlns: "http://www.w3.org/2000/svg"
  }, (topPat || bottomsPat) && React.createElement("defs", null, topPat && topPatId && React.createElement(PatternTile, {
    id: topPatId,
    def: topPat,
    ground: cl.base,
    motif: topMotif
  }), bottomsPat && bottomsPatId && React.createElement(PatternTile, {
    id: bottomsPatId,
    def: bottomsPat,
    ground: bc.base,
    motif: bottomsMotif
...
export { ANIMATIONS, ANIMATION_NAMES, Avatar, BOTTOMS_COLORS, Avatar as BeanHead, FrameAnimator, FullBeanHead, Noop, SHOE_COLORS, ThemeContext, accessoryMap, bodyMap, bottomsHex, bottomsMap, clothingMap, clothingPair, eyebrowsMap, eyesMap, facialHairMap, graphicMap, graphicsMap, hairMap, hatMap, imageGraphic, mouthsMap, patternMap, registerAnimation, registerBottoms, registerBottomsColor, registerClothingColor, registerGraphic, registerPattern, registerShoe, registerShoeColor, registerSkinTone, registerTop, shoeHex, shoeMap, skinPair, theme, topMap, useFrameAnimation };
